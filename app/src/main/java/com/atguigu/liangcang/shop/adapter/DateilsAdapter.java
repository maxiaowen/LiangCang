...
public class DateilsAdapter extends BaseAdapter {

    private final Context context;
    private final List<DetailsBean.DataBean.ItemsBean> datas;

    public DateilsAdapter(Context context, List<DetailsBean.DataBean.ItemsBean> items) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        DetailsBean.DataBean.ItemsBean itemsBean = datas.get(position);
