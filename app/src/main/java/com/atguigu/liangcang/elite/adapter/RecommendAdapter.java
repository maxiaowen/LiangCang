...
public class RecommendAdapter extends RecyclerView.Adapter {
    ...
    private final List<RecommendBean.ListBean> datas;
    ...
    public RecyclerView.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        ...
        switch (viewType) {
            case TYPE_VIDEO://视频
                ...
                View view = View.inflate(context, R.layout.all_video_item, null);
                viewHolder = new VideoHoder(view);
...
//            });
        ...
        public void setData(RecommendBean.ListBean mediaItem) {
            ...
            //设置标签
            List<RecommendBean.ListBean.TagsBean> tagsEntities = mediaItem.getTags();
...
//                        jcvVideoplayer.thumbImageView);
            ...
            tvVideoDuration.setText(UIUtils.stringForTime(mediaItem.getVideo().getDuration() * 1000) + "");
